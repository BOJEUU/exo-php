        ...
        <div class="container">
            <div class="row m-0 p-0 text-center">
                ...
                ?> <div class="row seven-cols m-0">
                    ...
                    ?>
                            <div class="card col-md-1 bg-info" style="width: 18rem;">
                                <img src="104e1e6830bae3ab606ca3cc92c860d6.jpg" class="card-img-top" alt="...">
                                <div class="card-body">
                        ...
                        ?>
                            <div class="card col-md-1" style="width: 18rem;">
                                <img src="Screenshot_26.png" class="card-img-top" alt="...">
                                <div class="card-body">
